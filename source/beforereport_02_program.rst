...
採用トークは日本語34コマ、英語16コマあります。
カテゴリ別の採用トーク数は以下のようになっています。

* Best Practices/Patterns: 3
* Big Data: 3
* Business: 1
* Cloud: 4
* Community: 1
* Concurrency: 1
* Core Python (Language, Stdlib): 3
* Databases/NoSQL: 2
...
トークの分野と対象参加者レベルを広くするため、今年のトークセッションは5トラック構成50コマとしました。
昨年と比較すると、1トラックあたりのコマ数は7コマから5コマに減りましたが、トータルのコマ数は33コマから50コマに増えています。

昨年までが「参加者がより多くのトークに参加できる構成」だとすると、今年は「参加者それぞれのレベルや目的にあったトークに集中できる」構成となっています。もしかしたら、参加したい複数のトークがおなじ時間帯に被ってしまうかもしれませんが、ほとんど全てのトークはライブ動画配信され、あとから見ることもできるので安心してください。

今年は、各トーク時間の間に必ず休憩時間が入るようにタイムテーブルを構成し、交流の機会を多く持てるようにしています。トークセッションに参加する方は、この時間を使って、疑問や質問を発表者に聞いてみて下さい。発表者と交流することには、現地参加でしか得られない価値がありますよ！
