...
今年は3月ごろから準備を始め以下のような企画、作業などがありました。
・キーノート
決定のためのプロセスの検討やキーノートスピーカーとのやり取りなど
・トークセッション
募集や選考など
・招待講演
招待講演者の決定ややり取りなど
...
当日の段取りの決定や募集
・2日間スプリント
スプリント会場(今年はマイクロソフト)とのやり取りや段取りなど

また、当日はオープニング、クロージングの司会と進行や各トークセッションでの司会と進行が大きな役割です。

今年は、上記した様々な企画がありました。
本レポートで一挙に各企画について振り返ります。PyCon JP 2016の雰囲気をこのレポートを通して味わってみてください。
