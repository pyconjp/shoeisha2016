...
カンファレンスデイの `タイムテーブル構成`_ は、キーノート2枠、招待講演2枠、トーク48枠、ポスター11枚、ビギナーセッション3枠、オープンスペース30枠としました。
トークは5トラックにすることで、1トラックの枠数を減らして休憩時間を多く取るようにしました。
このような構成にしたのは、ほとんど全てのトークは後から動画でも見られるので、トークを詰め込むよりも、交流する時間を多めにするという意図があったからです。
また、同じカテゴリが同じ部屋で連続しないようにしたり、休憩時間のタイミングをトラック毎にずらすことで、参加者が興味外にあったトークやブース、あるいは誰かに偶然出会う機会を増やすように構成しました。
皆さんは思いもよらない何かに出会えたでしょうか？

.. figure:: /_static/afterreport_02_program/talksession1.*
   :width: 200px

   トークセッションの様子

トークの採択では、Pythonが利用できるさまざまな領域を実感でき、知らない分野のトークに出会えるようにすることを目標に採択を行いました。
分野と対象参加者レベルがまんべんなく分散させるため、20のカテゴリについて3つの難易度を1つずつ採用しました
（PyCon JP Blog `PyCon JP 2016 Talk を決定しました`_ ）。
とはいえ、プロポーザルの少ないカテゴリではどんな内容でも採用した、ということはありませんでした。
プロポーザルのクオリティが年々向上してきてきたこともあり、採択の基準があがってきていますし、 `プロポーザルを公開している`_ ことにより、各提出者が他の方の内容をみて、良いところを取り込めることも影響していると思います。
多くのみなさんから提出された多様な108件のプロポーザルが、バラエティに富んだトークセッションのクオリティを支えてくれているのだと感じています。
おかげさまで本当に良いイベントになったと思います。ありがとうございました！

PyCon JP がどんなイベントであってほしいかは、みんな違っていると思います。
そんな中でトークはイベント期間では一番多くの時間を占めていることもあり、色々な意見がある部分かもしれません。
...
.. _PyCon JP 2016 Talk を決定しました: https://pyconjp.blogspot.jp/2016/07/pycon-jp-2016-accepted-talks.html
